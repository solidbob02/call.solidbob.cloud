...
**`fastapi/.importlinter`** — 2026-08-26 파일화 완료. 현재 `root_packages`는 실제로 존재하는 `hub`·`evaluation`·`core`뿐이다.
...
- 영역 루트 `CLAUDE.md`(예: `fastapi/CLAUDE.md`)는 스포크가 2개 이상 생겨 규칙이 분화될 때 만든다. 지금은 루트 하나 + `docs/`뿐이다.
