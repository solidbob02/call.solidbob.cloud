...
> **C-5 마스킹은 2026-08-27 장민석으로 이관됐다**(`_project/decisions/015`) — 티켓·코드가 없는
...
| **C-5** | 개인정보 실시간 마스킹 | `server/apps/masking/` (담당: **장민석** — 2026-08-27 이관, `_project/decisions/015`) | **P1~P7 패턴 마스킹 누락 0건 — 절대 규칙.** 화면·DB 저장 양쪽 앞단 적용, 원본 미보관 | [기능 명세 2.4](/docs/02/), [평가 설계](/docs/06/) |
