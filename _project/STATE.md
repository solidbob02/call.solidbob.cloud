...
**최종 갱신**: 2026-08-27 (frontend 디자인 토큰 통일·자막 스크롤백·검색/수동 검색/통화 후 처리/카드 채택 기록·도커 infra/ 단일화·apps/platform 랜딩 스캐폴딩 + ai 병합 — 류준 님 w2-naive-rag 완료로 첫 실측 Recall@5 0.857/MRR 0.702 확보, server는 규칙 완화 제안 후 팀 회신 대기)
