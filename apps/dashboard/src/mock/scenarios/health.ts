...
export const healthScenario: MockScenario = {
  ...
  wrapUp: {
    summary: [
      "며칠째 낫지 않는 기침 증상에 대해 문의했습니다.",
      "증상만으로 특정 질병을 단정하지 않고, 공식 자료 기준의 일반 정보만 안내했습니다.",
      "지속되거나 악화되는 증상은 의료기관 방문을 권했고, 진단·처방은 의료기관의 역할임을 안내했습니다.",
    ],
    category: "증상 문의 · 일반 안내",
    follow_ups: [
      "증상 지속 시 의료기관 방문 권고 재안내",
      "진단·처방 문의는 의료기관으로 연결",
    ],
  },
  closures: [],
