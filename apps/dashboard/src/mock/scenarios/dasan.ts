...
export const dasanScenario: MockScenario = {
  ...
  wrapUp: {
    summary: [
      "지하철 2호선에서 버스로 갈아탈 때 환승 할인이 적용되는지 문의했습니다.",
      "환승 할인 기준은 교통공사·운수업체 공개 자료를 근거로 안내했습니다.",
      "실시간 배차는 변동될 수 있어 버스 도착 확정 시각은 안내하지 않았습니다.",
    ],
    category: "교통 · 환승 안내",
    follow_ups: [
      "실시간 도착 정보는 교통 앱으로 확인하도록 안내",
      "환승 할인 기준 개정 시 공개 자료 갱신 확인",
    ],
  },
  closures: [],
};
