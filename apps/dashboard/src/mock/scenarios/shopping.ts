...
export const shoppingScenario: MockScenario = {
  ...
  wrapUp: {
    summary: [
      "사이즈가 맞지 않아 단순 변심으로 반품하겠다는 문의입니다.",
      "단순 변심 반품은 왕복 배송비를 이용자가 부담한다는 기준을 고지했습니다.",
      "환불 예정 금액과 소요 기간을 안내했습니다.",
      "상품 상태 확인이 남아 있어 반품 종결은 아직 보류된 상태입니다.",
    ],
    category: "반품 · 배송비 문의",
    follow_ups: [
      "반송 상품 상태 확인 후 반품 종결 처리",
      "환불 예정 금액·입금 시점 재안내",
    ],
  },
  closures: [
